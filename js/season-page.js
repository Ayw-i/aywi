// formatSeasonDate, formatGameTime, getEasternHour, isWeekendDate, isBackToBack,
// dateColor, and logoImg now live in js/nhl-schedule.js (shared with state.js's
// Schedule-Out table).
...
function renderSeasonTable(games, goalieMap) {
  ...
  for (var i = 0; i < regGames.length; i++) {
    ...
    if (isPlayed) {
      ...
      // Not yet played — leave Result blank; the time already shows under Date.
      resultText  = '';
      resultColor = '';
    }
